...
filePath = "/tmp/xjny_daily/edu_app_ts_jyjl/data" + data_day_str
data_day_str1 = "\'"+data_day_str+"\'"
sql = """
INSERT OVERWRITE LOCAL DIRECTORY '""" + filePath + """'
ROW FORMAT DELIMITED FIELDS TERMINATED BY '\t'
SELECT xh,jssj,tsmc,tslx,gjz,sfyq,yqts,jsdd,dt FROM app.edu_app_ts_jyjl WHERE dt=""" + data_day_str1 + """
;
"""
