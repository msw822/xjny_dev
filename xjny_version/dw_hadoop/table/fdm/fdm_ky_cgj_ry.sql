...
--    REVIEWER:
--    REVISION:
DROP TABLE IF EXISTS FDM.fdm_ky_cgj_ry;
CREATE EXTERNAL TABLE FDM.fdm_ky_cgj_ry(
  RYH string COMMENT '人员号,参与项目人员号（教工填写工号，学生填写学号）',
  XM string COMMENT '姓名',
  XB string COMMENT '性别',
  ZC string COMMENT '职称',
  DWH string COMMENT '单位号,见dim_dw',
