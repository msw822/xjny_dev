...
--    REVIEWER:
--    REVISION:
DROP TABLE IF EXISTS FDM.fdm_ky_zl_ry;
CREATE EXTERNAL TABLE IF NOT EXISTS FDM.fdm_ky_zl_ry (
  ...
  JSM string COMMENT '角色码,JY/T 1001 JS 角色代码[hb_js]',
